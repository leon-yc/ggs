...
import (
	...
	metricCollector "github.com/leon-yc/ggs/third_party/forked/afex/hystrix-go/hystrix/metric_collector"
	"github.com/leon-yc/ggs/third_party/forked/afex/hystrix-go/hystrix/rolling"
)
...
func newMetricExchange(name string, num int) *metricExchange {
	...
	qlog.Tracef(" launched [%d] Metrics consumer", num)
	return m
}
